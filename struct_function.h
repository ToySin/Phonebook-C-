#ifndef STRUCT_FUNCTION
#define STRUCT_FUNCTION
...
/*********************
	...
	Pre-Conditio
	- 입력받을 정보를 저장할 구조체포인터배열의 시작주소를 전달받는다.
...
/*********************
	...
	Pre-Conditio
	- 새롭게 메모리를 할당하여 정보를 입력받을 Info 포인터 값을 전달받는다.

	Post-Condition
	- 전달받은 포인터에 메모리를 할당하고 사용자로부터 입력받는 정보를 저장한다.

	Exception-Handling
	- 전달받은 값이 NULL값일 경우 "NULL PTR"을 출력한다.

	Describe
	- 사용자로부터 새로운 값을 입력받아 저장한다.
**********************/
void new_Info_insert(Info*);
...
/*********************
	...
	Pre-Conditio
	- 메모리를 해제하고자 하는 Info 포인터 값을 전달받는다.

	Post-Condition
	- 전달받은 구조체와 내부의 멤버변수들의 메모리 할당을 해제한다.

	Exception-Handling
	- 전달받은 값이 NULL값일 경우 "NULL PTR"을 출력한다.

	Describe
	- Info 구조체포인터가 할당받은 메모리를 해제한다.
**********************/
void free_Info(Info*);
#endif
